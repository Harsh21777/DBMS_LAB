...
int BlockAccess::insert(int relId, Attribute *record) {
    ...
    */
    ...
    for (int attrOffset = 0; attrOffset < numOfAttributes; attrOffset++) {
        ...
        int ret = BPlusTree::bPlusInsert(relId, attrCatBuf.attrName, record[attrOffset], rec_id);
        if (ret == E_DISKFULL)
    ...
    ***/
    ...
    while(true) {
        ...
        */
        ...
        // if (numberOfAttributesDeleted == numAttr) break;
    }
